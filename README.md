...
**Also references:** [03 — Training orchestration](https://github.com/Debashis2007/domain-fine-tuning/blob/main/03-distributed-training-orchestration.md)
...
Domain corpora → validate/quarantine → blessed manifest
  → train job ([03](https://github.com/Debashis2007/domain-fine-tuning/blob/main/03-distributed-training-orchestration.md))
  → domain evals → registry artifact
  → canary ([05](https://github.com/Debashis2007/domain-fine-tuning/blob/main/05-model-monitoring-observability.md))
```
